package com.cat.music.player.notification;
...
//        remoteViews.setTextViewText(R.id.notificationArtist, basePlayerImpl.getUploaderName());
        ...
        remoteViews.setOnClickPendingIntent(R.id.notificationPlayPause,
                PendingIntent.getBroadcast(mContext, NOTIFICATION_ID, new Intent(MusicPlayerService.ACTION_PLAY_PAUSE), PendingIntent.FLAG_UPDATE_CURRENT));
        remoteViews.setOnClickPendingIntent(R.id.notificationStop,
                PendingIntent.getBroadcast(mContext, NOTIFICATION_ID, new Intent(MusicPlayerService.ACTION_CLOSE), PendingIntent.FLAG_UPDATE_CURRENT));
        ...
        if (true) {
            remoteViews.setOnClickPendingIntent(R.id.notificationFRewind,
                    PendingIntent.getBroadcast(mContext, NOTIFICATION_ID, new Intent(MusicPlayerService.ACTION_PREV), PendingIntent.FLAG_UPDATE_CURRENT));
            remoteViews.setOnClickPendingIntent(R.id.notificationFForward,
                    PendingIntent.getBroadcast(mContext, NOTIFICATION_ID, new Intent(MusicPlayerService.ACTION_NEXT), PendingIntent.FLAG_UPDATE_CURRENT));
        } else {
            remoteViews.setOnClickPendingIntent(R.id.notificationFRewind,
                    PendingIntent.getBroadcast(mContext, NOTIFICATION_ID, new Intent(MusicPlayerService.ACTION_PREV), PendingIntent.FLAG_UPDATE_CURRENT));
            remoteViews.setOnClickPendingIntent(R.id.notificationFForward,
