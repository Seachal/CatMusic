...
//        mPresenter.loadMvComment(mVid,0);
//    }
//
//    @Override
...
//
//    @Override
//    public void showMvUrlInfo(String mvUrl) {
//        ExoPlayerManager.INSTANCE.setDataSource(mvUrl);
//    }
//
//    @Override
...
//        mTvLikeCount.setText(String.valueOf(info.getSubCount()));
...
//        ExoPlayerManager.INSTANCE.bindView(mVideoView);
